(function($){
    ...
    function remapStatLabel(key){
        const labels = {submissions_updated:'Заявок обновлено',fields_filled:'Полей заполнено',documents_updated:'Документов обновлено',accounts_updated:'Аккаунтов участников обновлено',unchanged:'Без изменений',skipped_suspicious:'Пропущено подозрительных',errors:'Ошибки'};
        return labels[key] || key;
    }
